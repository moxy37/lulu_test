...
a4 = aaaa.cursor()
a4.execute("SELECT productId, id, ts, x, y, storeId, styleCode FROM EpcMovement WHERE styleCode IS NOT NULL AND isExit=0 AND isDeparture=0 AND isSold=0 AND isGhost=0 AND isMissing=0 AND regionId<>'fe009192-4aec-3586-acf4-253710a66b3a' ORDER BY storeId, styleCode, productId, id, ts")
